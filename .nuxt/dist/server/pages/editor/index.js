...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/editor/index.vue?vue&type=template&id=7e950698&
...
// CONCATENATED MODULE: ./pages/editor/index.vue?vue&type=template&id=7e950698&
...
/* harmony default export */ var editorvue_type_script_lang_js_ = ({
  ...
  created() {
    if (this.$route.params._slug) {
      //获取文章详情
      Object(article["h" /* getArticle */])(this.$route.params._slug).then(res => {
  ...
  methods: {
    toPublish() {
      if (this.article.slug) {
        Object(article["n" /* updateArticles */])(this.article.slug, this.article).then(res => {
          this.$router.push('/article/' + res.data.article.slug);
        });
      } else {
        Object(article["c" /* createArticles */])(this.article).then(res => {
          this.$router.push('/article/' + res.data.article.slug);
        });
      }
    }
